...
#if defined(CONFIG_SDIO_HCI) && defined (FW_DOWNLOAD_SIZE_8723D)
...
#else
	padapter->registrypriv.wireless_mode = WIRELESS_11BG;
#endif
...
#if defined(CONFIG_SDIO_HCI) && defined(CONFIG_80211N_HT)
